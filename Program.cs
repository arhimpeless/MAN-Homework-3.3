namespace Задание_3_3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Здравствуй, Искатель!\nВведи положительное число, а я выведу ближайшее простое число на консоль.");
            while (true)
            {
                int neprostoe;
                int nepr_mal = 0;
                ...
                while (true)
                {
                    ...
                    {
                        Console.WriteLine("Я работаю только с положительными числами.");
                        break;
                    }
                    if (neprostoe > 0)
                    {
